                        ...
                        <form method="post">
                            <div class="row">
                                ...
                                ?>
                                            ...
                                            <div class="col-12"><label class="mx-2">Username</label><input disabled class="form-control m-2" type="text" placeholder="Username" name="editUsername" value=<?php echo $row['username'] ?> required></div>
                                            <div class="col-12"><label class="mx-2">Email</label><input disabled class="form-control m-2" type="email" placeholder="Email" name="editEmail" value=<?php echo $row['email'] ?> required></div>
                                            <div class="col-12"><label class="mx-2">Passport number</label><input disabled class="form-control m-2" type="text" placeholder="Passport No." name="editPassport" value=<?php echo $row['no_passport'] ?> minlength="8" maxlength="8" required></div>
...
<?php
                                ...
                                if (isset($_POST["signupName"]) && isset($_POST["signupUsername"]) && isset($_POST["signupEmail"]) && isset($_POST["passport"]) && isset($_POST["phoneNumber"]) && isset($_POST["signupPassword"])) {
                                    ...
                                    // $result = $stmt->get_result();
                                    // while($row = $result->fetch_assoc()){
                                    //     if ($_POST['editUsername'] != $row['username']){
                                    //         $stmtUser = $conn->prepare('SELECT * FROM user');
                                    //         $stmtUser->execute();
                                    //         $resultUser = $stmtUser->get_result();
                                    //         while($row2 = $result->fetch_assoc()){
                                    //             if ($_POST['editUsername'] == $row2['username']) {
                                    //                 echo '<script>
                                    //                 Swal.fire({
                                    //                     heightAuto: false,
