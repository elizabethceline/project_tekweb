...
?>
    ...
    <body>
        ...
        include("../navbar.php");
        ?>
        <div class="container rounded-4 mt-4">
            <div class="row">
                <div class="col-md-4 col-lg-3 bg-white border rounded-start-4" id="profpic">
                    ...
                    <div class="p-3 py-5">
                        ...
                        <div class="row mt-3">
                            <form method="post">
                                ...
                                <div class="col-md-12 mt-3"><label class="labels">Username</label><input type="text" readonly name="inputUsername" class="form-control" placeholder="Username" value=<?php echo $row['username']; ?>></div>
                                <div class="col-md-12 mt-3"><label class="labels">Email</label><input type="email" readonly name="inputEmail" class="form-control" placeholder="Email" value=<?php echo $row['email']; ?>></div>
                                ...
                                <div class="col-md-12 mt-3"><label class="labels">Passport number</label><input type="text" readonly name="inputNomorPassport" class="form-control" placeholder="Passport number" value=<?php echo $row['no_passport']; ?> minlength="8" maxlength="8"></div>
                ...
                <div class="col-md-8 col-lg-9 border rounded-end-4 bg-white" id="change-password">
                    <div class="p-3 py-5">
                        <div class="d-flex justify-content-between align-items-center mb-3">
